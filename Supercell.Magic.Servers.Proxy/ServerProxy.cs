...
namespace Supercell.Magic.Servers.Proxy
{
	...
	{
		public static DatabaseReader MaxMind
		{
			get; private set;
		}
		public static TcpServerSocket ServerSocket
		{
			get; private set;
		}
		public static CouchbaseDatabase AccountDatabase
		{
			get; private set;
		}
		public static RedisDatabase SessionDatabase
		{
			get; private set;
		}
