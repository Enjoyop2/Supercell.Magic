...
namespace Supercell.Magic.Titan.DataStream
{
	public class ChecksumEncoder
	{
		...
		{
			m_checksum = (value ? 13 : 7) + RotateRight(m_checksum, 31);
		}

		public virtual void WriteByte(byte value)
		{
			m_checksum = value + RotateRight(m_checksum, 31) + 11;
		}

		public virtual void WriteShort(short value)
		{
			m_checksum = value + RotateRight(m_checksum, 31) + 19;
		}

		public virtual void WriteInt(int value)
		{
			m_checksum = value + RotateRight(m_checksum, 31) + 9;
		}

		public virtual void WriteVInt(int value)
		{
			m_checksum = value + RotateRight(m_checksum, 31) + 33;
		}
		...
		public virtual void WriteLongLong(long value)
		{
			...
			m_checksum = high + RotateRight(low + RotateRight(m_checksum, 31) + 67, 31) + 91;
		}
		...
		{
			m_checksum = (value != null ? value.Length + 28 : 27) + RotateRight(m_checksum, 31);
		}

		public virtual void WriteStringReference(string value)
		{
			m_checksum = value.Length + RotateRight(m_checksum, 31) + 38;
		}
