	...
	public class StreamEntryFactory
	{
		public static StreamEntry CreateStreamEntryByType(StreamEntryType type)
		{
			switch (type)
			{
				...
				case StreamEntryType.VERSUS_BATTLE_REQUEST:
					return new VersusChallengeStreamEntry();
				case StreamEntryType.VERSUS_BATTLE_REPLAY:
					return new VersusBattleReplayStreamEntry();
