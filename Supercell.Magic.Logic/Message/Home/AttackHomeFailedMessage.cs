...
namespace Supercell.Magic.Logic.Message.Home
{
	public class AttackHomeFailedMessage : PiranhaMessage
	{
		...
		public override void Decode()
		{
			...
			m_protectionEndSeconds = m_stream.ReadInt();
		}
		...
		public override void Encode()
		{
			...
			m_stream.WriteInt(m_protectionEndSeconds);
		}

		public override short GetMessageType()
			=> AttackHomeFailedMessage.MESSAGE_TYPE;
		...
		public int GetProtectionEndSeconds()
			=> m_protectionEndSeconds;

		public void SetProtectionEndSeconds(int value)
		{
			m_protectionEndSeconds = value;
		}
