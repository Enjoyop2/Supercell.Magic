...
namespace Supercell.Magic.Logic.Command.Home
{
	public sealed class LogicMissionProgressCommand : LogicCommand
	{
		...
		{
			ByteStreamHelper.WriteDataReference(encoder, m_missionData);
			base.Encode(encoder);
		}

		public override LogicCommandType GetCommandType()
			=> LogicCommandType.MISSION_PROGRESS;
		...
		public override int Execute(LogicLevel level)
		{
			...
			{
				LogicMission mission = level.GetMissionManager().GetMissionByData(m_missionData);
